...
router.get('/all/:id', async (req: Request, res: Response) => {
    try {
        ...
        const programArray = getFieldsFromObject(response.body.data.fm, ['obiekt', 'dlugosc', 'szerokosc', 'id_obiekt', 'wys_npm', 'czestotliwosc', 'id_antena', 'id_nadajnik', 'id_program']);
